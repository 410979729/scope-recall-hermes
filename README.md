...
This checkout is `3.2.0rc1`, the line after the `3.1.2` release, and is where one store that several agents share is being built. A local store behaves exactly as it did in `3.1.2`.
