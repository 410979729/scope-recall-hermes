...
Version `1.8.7` is the cumulative public release since `1.8.2`. It keeps SQLite authoritative and the stable provider/tool identities unchanged while adding fail-closed runtime-principal isolation, authoritative freshness projection, safer vector and relation maintenance, canonical secret filtering, stronger Experience governance, and pinned Windows/macOS/Linux release validation.
