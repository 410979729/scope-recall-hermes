...
This checkout is `3.2.0rc2`, the line after the `3.1.2` release: one store that several agents share ([docs/shared-store.md](docs/shared-store.md)), whose first candidate, `3.2.0rc1`, is tagged for a pilot. A local store behaves exactly as it did in `3.1.2`.
