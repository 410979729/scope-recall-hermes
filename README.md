...
In August 2026 we ran Scope Recall's current development line (the upcoming `1.9.2` patch) end-to-end on the [LoCoMo](https://github.com/snap-research/locomo) long-conversation benchmark: all **1,540 questions** across the four non-adversarial categories, with **100% coverage and zero invalid results** — a full run, not a sample.
