...
CandidateChannel = Literal["lexical", "exact_ref", "vector", "recent_raw", "relation"]
...
class SearchLimits:
    ...
    def __post_init__(self) -> None:
        checks = {
            ...
            "relation_objects": (self.relation_objects, 0, 24),
...
class SearchContext:
    ...
    def from_request(
        ...
        *,
        ...
        payload = validate_model_request("recall_request", request, trusted_context)
...
class CandidateRef:
    ...
    def __post_init__(self) -> None:
        ...
        if self.source not in {"lexical", "exact_ref", "vector", "recent_raw", "relation"}:
