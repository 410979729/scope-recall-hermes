...
1. package and plugin metadata stay on `1.0.2` until the next patch release
...
- GitHub publication requires pushing a clean commit, waiting for remote CI, and creating the `v1.0.2` tag/release
