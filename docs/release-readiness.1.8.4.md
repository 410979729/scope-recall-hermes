# Scope Recall 1.8.4 Release Readiness

Date: 2026-08-01

This public maintainer note records the product-level release requirements for the `1.8.4` source tree. It excludes environment-specific health counters, filesystem locations, credentials, and private validation context. No tag, GitHub Release, or PyPI publication is implied by this document.

## Code gate status

- Package/plugin version: `1.8.4`.
...
- The release commit, tag, GitHub Release assets, and PyPI artifacts all identify version `1.8.4`.
