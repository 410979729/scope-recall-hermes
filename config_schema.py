...
_DESCRIPTION_OVERRIDES = {
    ...
    "auto_adjudication.l4_max_uncertain_rounds": "Uncertain grounded-review verdicts allowed before a candidate is archived as unresolvable instead of rotting in the queue.",
