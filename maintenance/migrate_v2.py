"""One-shot offline 578b -> Core 1.1 migration.

The old database is read-only.  This maintenance helper imports source truth,
episodes, temporal fact authority, procedure history, and deletion closure in
one Core transaction.  It does not import old engines, call a model, or create
new Core authority tables.
"""
...
from scope_recall.maintenance.legacy_tianshu_compat import (
    BRIDGE_TABLE, BRIDGE_COLUMNS, LegacyCompatibilityError,
    prepare_memory_storage_authority, resolve_memory_scope,
    verify_completed_bridge_archive,
    IMPORT_LEDGER_TABLE, IMPORT_LEDGER_COLUMNS, verify_import_ledger_archive,
)
